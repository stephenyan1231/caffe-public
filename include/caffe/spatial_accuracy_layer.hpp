...
class SpatialAccuracyLayer : public Layer<Dtype> {
 public:
  /**
   ...
   */
  explicit SpatialAccuracyLayer(const LayerParameter& param, int replica_id, Net<Dtype> *net)
  ...
  virtual inline const char* type() const { return "SpatialAccuracy"; }
  /* 1st bottom blob: feature map
...
#endif // CAFFE_SPATIAL_ACCURACY_LAYER_HPP_
